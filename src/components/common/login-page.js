          ...
          <div style={{ background: white, height: '86vh', marginLeft: '22.5vh', marginTop: '6vh', width: '80vh' }} class="column">
            <div style={{ background: white, height: '82vh', marginLeft: '9vh', width: '60vh' }} class="column">
              <div class="column">
                ...
                <div class="separator">
                  <div class="line"></div>
                  <h5 style={{ marginTop: '15px' }}>or Sign in with Email</h5>
                  <div class="line"></div>
                </div>
                <form class="ui form" onSubmit={this.onSubmit}>
                  <div class="field">
                    <label style={{ marginLeft: '4vh' }}>Email*</label>
                    <center> <input style={{ width: '50vh' }} type="text" name="email" placeholder="stek@gmail.com"></input></center>
                  </div>
                  <div class="field">
                  ...
                  <div class="field">
                    <div class="ui checkbox">
                      ...
                      <label style={{ marginLeft: '4vh' }}>Remember</label>
                    </div>
                  </div>
                ...
                <h4 style={{ marginLeft: '4vh' }}>Not Registered Yet ?  <a class="item" href="/sign-up">
                  Create an Account
                </a> </h4><br></br><br></br>
